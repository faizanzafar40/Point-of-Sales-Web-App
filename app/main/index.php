...
?>
	...
	<div class="span2">
          <div class="sidebar-nav">
			...
			<li><a href="employee_admin.php"><i class="icon-group icon-2x"></i> Employees</a>                                    </li>
			<li><a href="salesreport_admin.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Sales Report</a>                </li>
			<br><br><br><br><br><br>		
			<li>
	...
	<div class="pageheader">
			...
			<font style=" font:bold italic 44px 'Aleo';"><center>Cafe NUST</center></font>
<div id="mainmain">



<a href="employee_admin.php"><i class="icon-group icon-2x"></i><br> Employees</a>     
<a href="salesreport_admin.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Sales Report</a>
